...
// Invoke a method with symbol by name. The number indicates the
// number of arguments (not including the receiver and method name).
OPCODE(INVOKE_0, 0)
OPCODE(INVOKE_1, -1)
OPCODE(INVOKE_2, -2)
OPCODE(INVOKE_3, -3)
...
OPCODE(INVOKE_SUPER_0, 0)
OPCODE(INVOKE_SUPER_1, -1)
OPCODE(INVOKE_SUPER_2, -2)
OPCODE(INVOKE_SUPER_3, -3)
OPCODE(INVOKE_SUPER_4, -4)
OPCODE(INVOKE_SUPER_5, -5)
OPCODE(INVOKE_SUPER_6, -6)
OPCODE(INVOKE_SUPER_7, -7)
OPCODE(INVOKE_SUPER_8, -8)
OPCODE(INVOKE_SUPER_9, -9)
OPCODE(INVOKE_SUPER_10, -10)
OPCODE(INVOKE_SUPER_11, -11)
OPCODE(INVOKE_SUPER_12, -12)
OPCODE(INVOKE_SUPER_13, -13)
OPCODE(INVOKE_SUPER_14, -14)
OPCODE(INVOKE_SUPER_15, -15)
OPCODE(INVOKE_SUPER_16, -16)
