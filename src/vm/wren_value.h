...
//------------------------------------------------------------------------------
// In the collaboration diagrams generated by Doxygen, the inheritance is better
// shown through \extends than a usage relation via the member whose name is
// always `obj`, which is thus hidden through the \private command.
