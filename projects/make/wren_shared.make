...
DEFINES += -DNDEBUG
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) $(USEM64) -O2 -fPIC -std=c99
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) $(USEM64) -O2 -fPIC
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 $(USEM64) -shared -Wl,-soname=libwren.so -s
...
DEFINES += -DDEBUG
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) $(USEM64) -fPIC -g -std=c99
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) $(USEM64) -fPIC -g
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 $(USEM64) -shared -Wl,-soname=libwren_d.so
