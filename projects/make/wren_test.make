...
DEFINES += -DNDEBUG
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) $(USEM64) -O2 -std=c99
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) $(USEM64) -O2
LIBS += ../../lib/libwren.a -lm
LDDEPS += ../../lib/libwren.a
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 $(USEM64) -s
...
DEFINES += -DDEBUG
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) $(USEM64) -g -std=c99
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) $(USEM64) -g
LIBS += ../../lib/libwren_d.a -lm
LDDEPS += ../../lib/libwren_d.a
ALL_LDFLAGS += $(LDFLAGS) -L/usr/lib64 $(USEM64)
